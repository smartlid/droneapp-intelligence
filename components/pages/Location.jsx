...
const ProductShingle = dynamic(() => import("./slides/ProductShingle"), {
  ssr: false,
});
...
const RoofIntelligence = dynamic(() => import("./slides/RoofIntelligence"), {
  ssr: false,
});
const HailImpacts = dynamic(() => import("./slides/HailImpacts"), {
  ssr: false,
});
  ...
  return (
    <>
      {<Home record={record} setPaginationClass={setPaginationClass} />}
      {
        <ProductShingle
          record={record}
          setPaginationClass={setPaginationClass}
        />
      }
