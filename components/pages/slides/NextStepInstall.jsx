      ...
      <div className={styles.content}>
        ...
        <div style={{ marginTop: "2%", display: "flex", justifyContent: "space-between" }}>
          <div style={{ flex: "0 0 50%", padding: "0 0 0 5%", color: "#868686", fontWeight: "bolder" }}>
            ...
            <p className={`${styles.list} ${styles.last} ${styles.active}`}>Roof Installation</p>
            <p style={{ fontSize: "18px" }}>{`Remote Roofing’s experienced team completes the roof replacement and installation `}</p>
