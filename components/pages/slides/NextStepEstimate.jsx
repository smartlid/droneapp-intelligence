      ...
      <div className={styles.content}>
        ...
        <div style={{ marginTop: "2%", display: "flex", justifyContent: "space-between" }}>
          <div style={{ flex: "0 0 50%", padding: "0 0 0 5%", color: "#868686", fontWeight: "bolder" }}>
            ...
            <p className={`${styles.list} ${styles.active}`}>Finalized Estimate</p>
            <p style={{ fontSize: "18px" }}>{`Remote Roofing’s team ensures all the damages have received insurance coverage`}</p>
