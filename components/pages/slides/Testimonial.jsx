    ...
    >
      ...
      <div className={styles.content}>
          ...
          >
            ...
            <div className={styles.testimonial__buttons} style={{ position: "absolute", right: "-50px", transform: "translate(100%, -20%)" }}>
              <img src="/assets/google.png" className={styles["testimonial__button"]} />
              <img src="/assets/bbb.png" className={styles["testimonial__button"]} />
            </div>
          </div>
        ...
        <div className={styles["testimonial__item-container"]}>
          <div className={styles.testimonial__item}>
            ...
            <div style={{ width: "80%", height: "40%", background: "#c4c4c4" }}></div>
          </div>
          <div className={styles.testimonial__item}>
            <h4 className={styles.testimonial__name}>Steve favre</h4>
            <div className={styles.testimonial__rating}>
