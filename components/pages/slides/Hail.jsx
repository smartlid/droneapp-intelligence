    ...
    <div className={`${styles.slide} ${styles.hail}`}>
      ...
      <div className={styles.hail__content}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginRight: "20px" }}>
          <img src="/assets/hail-button.png" alt="map-image" width="70" height="70" className="fade-in-top-down" style={{ animationDelay: ".5s" }} />
          <div style={{ flex: "1 0" }}>
        ...
        <div style={{ flex: "1 0" }}>
          ...
          <p className={`${styles.hail__description} fade-in-top-down`}>The DFW metroplex is in the heart of the nation's hail alley.</p>
          ...
          <div style={{ padding: "20px 0" }}>
            ...
            <div style={{ display: "flex", flexWrap: "nowrap", justifyContent: "space-between" }}>
              ...
              <div style={{ flex: "0 0" }}>
                ...
                <img src="assets/roof-scheme.png" style={{ margin: "80px 0 0 -50px", width: "100%" }} />
              </div>
            </div>
